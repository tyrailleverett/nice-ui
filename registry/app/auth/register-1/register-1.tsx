...
export interface Register1Avatar {
  alt: string;
  fallback: string;
  src: string;
}

export interface Register1Image {
  alt: string;
  src: string;
}

export interface Register1Testimonial {
  avatar?: Register1Avatar;
  name?: string;
  quote?: ReactNode;
  role?: string;
}

export interface Register1TrustedByLogo {
  alt: string;
  label?: string;
  src: string;
}

export interface Register1TrustedBy {
  logos: Register1TrustedByLogo[];
  title: string;
}

export interface Register1Props {
  className?: string;
  description?: string;
  ...
  signInLabel?: string;
  signInPrompt?: string;
  testimonial?: Register1Testimonial;
  title?: string;
  trustedBy?: Register1TrustedBy | null;
}

const defaultTestimonial: Register1Testimonial = {
  avatar: {
...
const defaultPanelImage: Register1Image = {
...
const defaultTrustedBy: Register1TrustedBy = {
  logos: [
    {
      alt: "OpenAI",
