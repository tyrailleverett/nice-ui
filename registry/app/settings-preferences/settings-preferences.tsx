  ...
  return (
    <div className={cn("mx-auto flex w-full max-w-5xl flex-col gap-8 p-4 sm:p-8", className)}>
      ...
      <PreferenceSection title="General">
        <SettingsRow description="Choose which layout opens on launch." label="Default view">
          <SelectField
            defaultValue="Board"
        ...
        <SettingsRow description="Set how dates appear across the app." label="Date format">
          <SelectField
        ...
        <SettingsRow description="Used for calendars and date pickers." label="First day of week">
          <SelectField
            defaultValue="Monday"
            items={["Monday", "Sunday"]}
        ...
        <SettingsRow description="Automatically save unsaved changes." label="Auto-save drafts">
      ...
      <PreferenceSection title="Display">
        <SettingsRow description="Choose your preferred color scheme." label="Color theme">
          <SelectField
            defaultValue="System"
        ...
        <SettingsRow description="Set the navigation sidebar placement." label="Sidebar position">
          <SelectField defaultValue="Left" items={["Left", "Right"]} label="Sidebar position" />
        </SettingsRow>
        <SettingsRow description="Minimize motion for accessibility." label="Reduce animations">
          <div className="flex justify-end">
            <SettingsSwitch label="Toggle reduce animations" />
          </div>
        </SettingsRow>
        <SettingsRow description="Display helpful hints on hover." label="Show tooltips">
          <div className="flex justify-end">
