...
export const Workspace: Story = {
  play: async ({ canvas }) => {
    await userEvent.click(canvas.getByRole("button", { name: jonBellConversation }));
    await expect(canvas.getByRole("heading", { name: "Question about SSO setup" })).toBeVisible();
    ...
    await expect(canvas.getByText("Check SAML provisioning docs.")).toBeVisible();
    await userEvent.click(canvas.getByRole("button", { name: "Resolve conversation" }));
