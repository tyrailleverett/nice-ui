      ...
      <div className="mx-auto flex max-w-3xl flex-col gap-5">
        <Empty className="border border-dashed">
          <EmptyHeader className="max-w-lg">
            ...
            <EmptyTitle className="text-xl">Inventory writes are frozen</EmptyTitle>
            <EmptyDescription>
              Dock systems are in a scheduled maintenance window. You can still read the queue. You
              cannot release holds or start recounts until 03:00 UTC.
            </EmptyDescription>
          </EmptyHeader>
          <EmptyContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              The freeze is scoped to writes against inventory, not the whole workspace.
            </CardDescription>
          </CardHeader>
