...
export type Footer1NavLink = {
  href: string
  label: string
}

export type Footer1SocialLink = {
  href: string
  label: string
  icon: ReactNode
}

export type Footer1BuiltBy = {
  name: string
  href: string
  imageSrc?: string
  imageAlt?: string
      ...
      <div className="flex flex-col gap-6 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            {logo ?? (
              <span className="font-heading h-4.5 text-sm font-semibold tracking-tight">
                Nice UI
              </span>
            )}
          </div>
