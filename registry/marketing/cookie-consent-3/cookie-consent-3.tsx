...
export function CookieConsent3({ className, onAccept, onManage, onReject }: CookieConsent3Props) {
  return (
    <aside
    ...
    >
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground text-sm leading-6">
          We use essential cookies to keep Nice UI working and optional analytics to understand what
          people find useful. You can change your choice at any time.
        </p>
