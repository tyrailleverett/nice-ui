            ...
            <div className="mt-12 grid grid-cols-1 border-y md:grid-cols-3">
              <article className="flex flex-col justify-between gap-6 border-b p-8 md:col-span-2 md:row-span-2 md:border-r md:border-b-0 md:p-10">
                <div className="flex flex-col gap-3">
                  <h3 className="font-heading font-semibold text-title">{featured.title}</h3>
                  <p className="max-w-md text-muted-foreground text-sm">{featured.description}</p>
                </div>
                <div aria-hidden className="aspect-video w-full border border-border bg-muted" />
              </article>
