...
export type Footer2NavLink = {
  href: string
  title: string
}

export type Footer2SocialLink = {
  href: string
  label: string
  icon: ReactNode
}
    ...
    >
      ...
      <div className="grid max-w-5xl grid-cols-6 gap-6 p-4">
        <div className="col-span-6 flex flex-col gap-4 pt-5 md:col-span-4">
          <a className="w-max" href={logoHref}>
            {logo ?? (
        ...
        <LinkColumn title={resourceTitle} links={resourceLinks} />
        <LinkColumn title={companyTitle} links={companyLinks} />
      </div>
      <FullWidthDivider />
