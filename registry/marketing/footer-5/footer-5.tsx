...
export type Footer5Link = {
  href: string
  label: string
}

export type Footer5LinkGroup = {
  title: string
  links: Footer5Link[]
}

export type Footer5Column = {
  groups: Footer5LinkGroup[]
}

export type Footer5SocialLink = {
  href: string
  label: string
  icon: ReactNode
}
        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,2fr)] lg:gap-16">
          <div className="flex max-w-sm flex-col gap-6">
            ...
            <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
              <label className="text-sm font-medium" htmlFor="footer-5-email">
                {newsletterLabel}
              </label>
