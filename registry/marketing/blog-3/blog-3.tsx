...
const defaultPosts: Blog3Item[] = [
  {
    author: "Ava Mitchell",
    description: "How to build a design system that scales with your team and product.",
    href: "#",
  ...
  {
    author: "Liam Carter",
    description: "Why color choices change how people feel and act in an interface.",
    href: "#",
    ...
    >
      <div className="flex h-full flex-col rounded-lg border border-transparent p-3 transition-colors group-hover:border-border group-focus-visible:border-border md:p-4">
        <img
          ...
          width={320}
        />
        <h3 className="font-semibold text-foreground text-lg md:text-xl">{title}</h3>
        <p className="mt-2 line-clamp-2 text-muted-foreground text-sm">{description}</p>
